...
class OrderSeeder extends Seeder
{
    ...
    {
        $order = [
            ['id' => 11, 'dinein' => 0, 'metode_payment' => 'tunai', 'users_id' => 4, 'status' => 'selesai'],
            ...
            ['id' => 15, 'dinein' => 0, 'metode_payment' => 'tunai', 'users_id' => 4, 'status' => 'proses'],
            ['id' => 16, 'dinein' => 1, 'metode_payment' => 'qris', 'users_id' => 4, 'status' => 'selesai'],
            ['id' => 17, 'dinein' => 0, 'metode_payment' => 'qris', 'users_id' => 5, 'status' => 'proses'],
            ['id' => 18, 'dinein' => 1, 'metode_payment' => 'tunai', 'users_id' => 5, 'status' => 'selesai'],
            ...
            ['id' => 23, 'dinein' => 0, 'metode_payment' => 'tunai', 'users_id' => 6, 'status' => 'selesai'],
