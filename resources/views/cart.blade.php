  ...
  @if (count($cart) > 0)
      <table class="table">
        ...
        <tbody>
          ...
          <tr>
            <td><img width="170px" height="170px" src="{{ $r['food']->image }}" class="attachment-blog_libra_small wp-post-image" alt="Photo of Food #{{ $r['food']->id }}" /></td>
            <td>{{ $r['food']->nama }}</td>
            <td>{{ $r['quantity'] }}</td>
            ...
            <td>
              ...
              {{-- Form delete harus berada di luar form checkout --}}
